...
to review. Approving moves it to ./content/posts where build.py renders it live.
...
Commands:
    ...
    py blog_pipeline.py approve <slug>    # move a draft -> content/posts (then run: py build.py)
...
POSTS = os.path.join(HERE, "content", "posts")
...
def generate() -> None:
    ...
    # Assemble the draft in the structure build.py expects, plus a compliance footer.
    post = {
